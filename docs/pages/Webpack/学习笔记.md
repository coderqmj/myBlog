...
- 可以直接打包一个信息文件出来供我们查看打包文件的信息，包括哈希值和每个包的大小等
...
### 2.自定义loader案例--解析markdown

- 想要解析md文件，就需要css-loader，less-loader这种文件解析loader
- 所以我们也需要自己的md解析loader
  - 首先需要将md内容转为html的内容
  - 然后挂载的到html元素中
- 可以使用marked依赖将md文件解析成html
