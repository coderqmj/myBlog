...
其中 language 是 [ISO 639-1 标准](https://zh.wikipedia.org/zh-hans/ISO_639-1 "https://zh.wikipedia.org/zh-hans/ISO_639-1")中定义的双字母的语言代码，territory 是 [ISO 3166-1 标准](https://zh.wikipedia.org/wiki/ISO_3166-1 "https://zh.wikipedia.org/wiki/ISO_3166-1")中定义的双字母的国家和地区代码，codeset 是字符集的名称 (如 UTF-8等)，而 modifier 则是某些 locale 变体的修正符。
...
![截屏2023-11-22 下午9.06.57.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/694faf9092c0484a905950176d80bd43~tplv-k3u1fbpfcp-jj-mark:1600:0:0:0:q75.jpg#?w=1254&h=304&s=75458&e=png&b=292929)
...
首先是 [negotiator](https://www.npmjs.com/package/negotiator "https://www.npmjs.com/package/negotiator") 这个库，将请求作为参数传给 Negotiator 构造函数，就可以通过 `new Negotiator(request).languages()` 快速获取支持的语言，比如请求的 accept-language 为 `'en;q=0.8, es, pt'`， `new Negotiator(request).languages()` 的值为 `['es', 'pt', 'en']`。

其次是 [@formatjs/intl-localematcher](https://www.npmjs.com/package/@formatjs/intl-localematcher "https://www.npmjs.com/package/@formatjs/intl-localematcher") 这个库，它的 match 函数，顾名思义，帮助匹配出最适合的语言，比如：
...
如果要为一组区域设置生成静态路由，我们可以在布局或页面中使用 [generateStaticParams](https://juejin.cn/book/7307859898316881957/section/7309079586296791050#heading-1 "https://juejin.cn/book/7307859898316881957/section/7309079586296791050#heading-1")。可以在全局中使用，比如这个例子就是在根布局中：
...
1. [《实战篇 | React Notes | 国际化》](https://juejin.cn/book/7307859898316881957/section/7309112133474582578 "https://juejin.cn/book/7307859898316881957/section/7309112133474582578")
2. [《实战篇 | 移动端 Web | Crowdin 与本地化》](https://juejin.cn/book/7307859898316881957/section/7309115955198558217 "https://juejin.cn/book/7307859898316881957/section/7309115955198558217")

## 参考链接

1. [I18N](https://baike.baidu.com/item/I18N/6771940 "https://baike.baidu.com/item/I18N/6771940")
2. [wiki/区域设置](https://zh.wikipedia.org/wiki/%E5%8C%BA%E5%9F%9F%E8%AE%BE%E7%BD%AE "https://zh.wikipedia.org/wiki/%E5%8C%BA%E5%9F%9F%E8%AE%BE%E7%BD%AE")
3. [Routing: Internationalization | Next.js](https://nextjs.org/docs/app/building-your-application/routing/internationalization "https://nextjs.org/docs/app/building-your-application/routing/internationalization")